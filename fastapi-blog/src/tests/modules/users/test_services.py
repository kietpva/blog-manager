...
from src.app.modules.users.schemas import UserCreate, UserUpdate
...
def test_partial_update_calls_check_permission_and_repo_update(
    ...
    monkeypatch.setattr(
        "src.app.modules.users.services.check_permission", check_permission_mock
    )
    monkeypatch.setattr(
        "src.app.modules.users.services.apply_partial_update", apply_partial_update_mock
    )
